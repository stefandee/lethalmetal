...
public class CObjAISlasher extends CObjBase
{
  ...
  public CObjAISlasher(CLevel _level, CXSprite _sprite, int _x, int _y, int _stance, int _health, int _damage, int _aggresivity, int _patrolDistance, int _color, int _friendly)
  {
    ...
    mActions = mLevel.mAISlasherActions;
  ...
  {
  	//System.out.println("CObjAISlasher.Update");
    super.Update();
  ...
  final public void ManageObjCollision(CObjBase _obj)
  {
    ...
    //  return;
    //}
    //System.out.println("slasher manage obj collision");
    ...
    //{
      ...
      if (IsDead())
      {
        mLevel.AddObject(new CObjAnimation(mLevel, mLevel.mSpriteManager.AddSprite("EXPL"), GetMidX(), GetMidY(), true, 2, Graphics.HCENTER | Graphics.VCENTER, 0));
        //mLevel.mShotEnemies++;
      }
